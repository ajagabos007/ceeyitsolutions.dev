...
class GatewayController extends Controller
{
    public function index()
    {
        ...
        $gateways = Gateway::where("status", 1)->orwhere("status", 2)->orderBy('name')->with('currencies')->get();
        // $gateways = Gateway::where("status", 0)->orderBy('name')->automatic()->with('currencies')->get();
