...
class SmsTemplateController extends Controller
{
    ...
    public function smsSettingUpdate(Request $request){
        $request->validate([
            ...
            'api_key' => 'required_if:sms_method,clickatell,messageBird,nexmo',
            'username' => 'required_if:sms_method,infobip,smsBroadcast,textMagic',
            'password' => 'required_if:sms_method,infobip,smsBroadcast',
            'api_secret' => 'required_if:sms_method,nexmo',
