                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row mt-4 d-none configForm" id="clickatell">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" placeholder="@lang('Api Key')" name="api_key" value="{{ @$general->sms_config->api_key }}"/>
                            </div>
                        </div>
                        <div class="form-row mt-4 d-none configForm" id="infobip">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" placeholder="@lang('Username')" name="username" value="{{ @$general->sms_config->username }}"/>
                            </div>
                            <div class="form-group col-md-6">
                                <label class="font-weight-bold">@lang('Password') <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" placeholder="@lang('Password')" name="password" value="{{ @$general->sms_config->password }}"/>
                            </div>
                        </div>
                        ...
                        <div class="form-row mt-4 d-none configForm" id="nexmo">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" placeholder="@lang('Api Secret')" name="api_secret" value="{{ @$general->sms_config->api_secret }}"/>
                            </div>
                        </div>
