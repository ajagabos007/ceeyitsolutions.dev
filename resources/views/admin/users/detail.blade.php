            ...
            <div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <a href="{{route('admin.instructor.totalCourses',$user->id)}}">@lang('Total Published Courses')</a>
                            <span class="font-weight-bold"><a href="{{route('admin.instructor.totalCourses',$user->id)}}">{{$totalCourses}}</a></span>
                        </li>
            ...
            <div class="row mb-none-30">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--17 b-radius--10 box-shadow has--link">
                        ...
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{$purchasedCourses}}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('Total Purchased Courses')</span>
                            </div>
                        </div>
                    </div>
                </div><!-- dashboard-w1 end -->
