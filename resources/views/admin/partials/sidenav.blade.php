    ...
    <div class="sidebar__inner">
        ...
        <li class="sidebar-menu-item sidebar-dropdown">
            <a href="javascript:void(0)" class="{{menuActive('admin.instructor*',3)}}">
                ...
                @if($banned_instructor_count > 0 || $email_unverified_instructor_count > 0 || $email_unverified_instructor_count > 0)
                <span class="menu-badge pill bg--primary ml-auto">
                    <i class="fa fa-exclamation"></i>
                </span>
                @endif
            ...
            <div class="sidebar-submenu {{menuActive('admin.instructor*',2)}} ">
                <ul>
                    ...
                    <a href="{{route('admin.instructor.sms.unverified')}}" class="nav-link">
                        ...
                        <span
                            class="menu-badge pill bg--primary ml-auto">{{$sms_unverified_instructor_count}}</span>
                        @endif
                    </a>
        </li> --}}
