          ...
          <div class="account-form-area">
            ...
            <form class="account-form mt-5" method="POST" action="{{route('user.verify.email')}}">
              ...
              <div class="row gy-1">
                ...
                <div class="col-sm-12">
                    <p><small>@lang('Please check including your Junk/Spam Folder. if not found, you can')</small> <a href="{{route('user.send.verify.code')}}?type=email" class="forget-pass text--base"> <small>@lang('Resend code')</small></a></p>
