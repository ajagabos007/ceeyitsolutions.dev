...
<nav class="navbar navbar-expand-lg">
  <div class="container-fluid">
    ...
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav">
      <span class="navbar-toggler-icon" style="width:0.5em;height: 0.5em;" ></span> 
    </button>
    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
      <img src="/assets/images/ceeyit_logo.png" alt="" style="float: left; margin-right: 750px;">
      <ul class="navbar-nav align-items-center">
        ...
        <li class="nav-item ms-lg-3">
          <a href="{{route('user.register')}}"><button class="btn btn-signup btn-signup-first btn-sm">Sign up</button></a>
        </li>
        @endguest
